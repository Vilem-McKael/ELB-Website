...
import edie1 from '/edieImages/edie1.jpeg'
import edie2 from '/edieImages/edie2.jpeg'
import edie3 from '/edieImages/edie3.jpeg'
import edie4 from '/edieImages/edie4.jpeg'
import edie5 from '/edieImages/edie5.jpeg'
import edie6 from '/edieImages/edie6.jpeg'
import edie7 from '/edieImages/edie7.jpeg'
import edie8 from '/edieImages/edie8.jpeg'
import edie9 from '/edieImages/edie9.jpeg'
import edie10 from '/edieImages/edie10.jpeg'
import edie11 from '/edieImages/edie11.jpeg'
import edie12 from '/edieImages/edie12.jpeg'
import edie13 from '/edieImages/edie13.jpeg'
import edie14 from '/edieImages/edie14.jpeg'
import edie15 from '/edieImages/edie15.jpeg'
import edie16 from '/edieImages/edie16.jpeg'
import edie17 from '/edieImages/edie17.jpeg'
import edie18 from '/edieImages/edie18.jpeg'
import edie19 from '/edieImages/edie19.jpeg'
import edie20 from '/edieImages/edie20.jpeg'
import edie21 from '/edieImages/edie21.jpeg'
import edie22 from '/edieImages/2 Steps rehearsal at Disney Hall.jpeg'
import edie23 from '/edieImages/2sfh.6.14.13_1991.jpg'
import edie24 from '/edieImages/30 Seconds to Mars session.jpg'
import edie25 from '/edieImages/Amistad ELB singer in John Williams Choir.jpeg'
import edie26 from '/edieImages/Amistad John Williams.jpg'
import edie27 from '/edieImages/Angélique Kidjo.jpg'
import edie28 from '/edieImages/ASCAP.jpeg'
import edie29 from '/edieImages/Avatar 2 choir.jpeg'
import edie30 from '/edieImages/Billie Eilish Grammys 2020 Group.jpg'
import edie31 from '/edieImages/Coachella Yeah Yeah Yeahs.jpeg'
import edie32 from '/edieImages/Coachella Yeah.jpeg'
import edie33 from '/edieImages/Danny Elfman @ The HO Bowl.jpeg'
import edie34 from '/edieImages/Disney Hall 2 Steps From Hell.jpg'
import edie35 from '/edieImages/Disney Hall 2sfh.6.14.13_1227.jpg'
import edie36 from '/edieImages/Dune Pic copy.jpeg'
import edie37 from '/edieImages/ELB @ Remote copy.jpg'
import edie38 from '/edieImages/ELB at FIF copy.jpg'
import edie39 from '/edieImages/ELB Conducting The Lion King.jpg'
import edie40 from '/edieImages/ELB Conductor.jpg'
import edie41 from '/edieImages/ELB John Powell SAG Award.jpeg'
import edie42 from '/edieImages/ELB Kids Choir w_ Vampire Weekend on James Corden Late Show.jpeg'
import edie43 from '/edieImages/ELB on Tour w_ Quincy.jpeg'
import edie44 from '/edieImages/ELB Organist.jpeg'
import edie45 from '/edieImages/ELB Teddy Shapiro.jpeg'
import edie46 from '/edieImages/ELB The Voice Piano.jpeg'
import edie47 from '/edieImages/ELB Violin.jpeg'
import edie48 from '/edieImages/ELB_Jon Favreau.jpeg'
import edie49 from '/edieImages/elbHeadshot2.jpeg'
import edie50 from '/edieImages/Ellen 30 seconds.jpeg'
import edie51 from '/edieImages/Gospel Choir w_Jordan of The Voice.jpeg'
import edie52 from '/edieImages/Grammy group w_ Hans & Pharrell.jpeg'
import edie53 from '/edieImages/Hairspray Live copy.jpg'
import edie54 from '/edieImages/Hans_Pharrell Grammys copy.jpg'
import edie55 from '/edieImages/Herb Alpert ELB session.jpeg'
import edie56 from '/edieImages/Herb Alpert_Richard Carpenter Capitol.jpg'
import edie57 from '/edieImages/Hidden Figures.jpeg'
import edie58 from '/edieImages/Ice Age 4 Choir_Tom Carlson - 039.jpg'
import edie59 from '/edieImages/Jimmy Kimmel 2019.jpeg'
import edie60 from '/edieImages/Jimmy Kimmel Clairo_kids.jpeg'
import edie61 from '/edieImages/Jimmy Kimmel Kids 2019 Sept.jpeg'
import edie62 from '/edieImages/Jimmy Kimmel Kids Choir.jpg'
import edie63 from '/edieImages/Jimmy Kimmel Kids.jpeg'
import edie64 from '/edieImages/Jon Favreau LK ELB.jpg'
import edie65 from '/edieImages/Katy Perry Instagram Pendulum.jpeg'
import edie66 from '/edieImages/Katy Perry Tweet ELB.jpg'
import edie67 from '/edieImages/Michael Abels US kids.jpg'
import edie68 from '/edieImages/Mr. Inglesias w_ Ismael.jpeg'
import edie69 from '/edieImages/Quincy Back On The Block.jpg'
import edie70 from '/edieImages/Quincy BOTB.jpg'
import edie71 from '/edieImages/Quincy Superfest Tour.jpg'
import edie72 from '/edieImages/Rosalia ELB session w_ Caroline Shaw.jpeg'
import edie73 from '/edieImages/Shirley Walker session 1993.jpg'
import edie74 from '/edieImages/Soap Opera Digest.jpeg'
import edie75 from '/edieImages/Soap Star pic.jpeg'
import edie76 from '/edieImages/Solo Contractor credit.jpeg'
import edie77 from '/edieImages/Tay & ELB.jpeg'
import edie78 from '/edieImages/Taylor & ELB_EELB.jpeg'
import edie79 from '/edieImages/Taylor & ELB, EELB.jpg'
import edie80 from '/edieImages/Taylor EELB, ELB 2.jpg'
import edie81 from '/edieImages/The Ellen Show 30STM.jpg'
import edie82 from '/edieImages/The Lion King Capitol Records.jpg'
import edie83 from '/edieImages/The Lion King Large group.jpg'
import edie84 from '/edieImages/The Lion King, Hans eyes closed.jpg'
import edie85 from '/edieImages/The Lorax.jpeg'
import edie86 from '/edieImages/The Used @ Amoeba Live.jpg'
import edie87 from '/edieImages/The Used live at Amoeba.jpeg'
import edie88 from '/edieImages/The Voice - Natural Woman.jpeg'
import edie89 from '/edieImages/The Voice 2012.jpeg'
import edie90 from '/edieImages/The Voice 2015.jpeg'
import edie91 from '/edieImages/The Voice early on copy.jpg'
import edie92 from '/edieImages/The Voice Gospel Choir Jordan Smith.jpeg'
...
export const videoData = [
    ...
    {
        title: "The Remarkable Hollywood Journey of Edie Lehmann Boddicker | Passionate Living",
        description: `Get ready for a captivating episode as Cat Miller sits down with the multi-talented Edie Lehman Boddicker on Passionate Living TV. From major Hollywood blockbusters to television stardom and singing alongside major stars, Edie has truly done it all.\n
        🌈 Join us as we explore the extraordinary musical career of a woman who has left an indelible mark on the entertainment industry. Edie's story is a testament to the power of dreams and the unexpected twists that life can bring. As she wisely says, "Be careful what you wish for, as it just might come true!"`,
        videoId: "98zVwebpScU"
    },
    {
        title: "Vocal Journey into Hollywood Music with Edie Lehmann Boddicker | Passionate Living",
...
The video is a full faithful performance from the premiere concert of the Tubular Bells II album at Edinburgh Castle. The tour continued until the following October. John Gordon Sinclair performed the part of the Master of Ceremonies at the concert; on the album Alan Rickman was the Master of Ceremonies. The concert finishes with a reprise of "The Bell". Eight thousand people were at the concert in Edinburgh, Scotland.`,
    ...
    {
        title: "Edie Lehmann - Hit And Run Lovers (Soundtrack Unreleased)",
        description: 'From the movie "Windy City" (1984).',
        videoId: "ys5C7lsf5S4"
    },
    {
...
import heavenIsAPlaceOnEarth from '/audio/heavenIsAPlaceOnEarth.mp3'
import papaDontPreach from '/audio/papaDontPreach.mp3'
...
export const audioData = [
    {
        ...
        description: "Grammy Nominated - Background Vocals by Edie Lehmann Boddicker",
        audioFile: '/audio/heavenIsAPlaceOnEarth.mp3',
        image: "/creditImages/heavenOnEarth.webp"
    },
    {
        title: "Papa Don't Preach",
        artist: "Madonna",
        album: "True Blue",
        description: "Grammy Nominated - Background Vocals and Vocal Arrangements by Edie Lehmann Boddicker",
