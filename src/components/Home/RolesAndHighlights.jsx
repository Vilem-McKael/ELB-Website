...
import arranger from '/edieImages/edie4.jpeg'
  ...
  return (
    <div id='roles-&-highlights' className='flex flex-col w-full items-center'>
      ...
      {/* SECTION TITLE: ROLES & HIGHLIGHTS */}
        ...
        <JobTitleCard bgColor={"#45848A"} alignment={'right'} title={"Conductor"} tag={"conductor"} description={"Edie has conducted for dozens of blockbuster films, from small groups to choirs of more than 80 people. She also conducts for live events and has worked in some of the most prestigious venues in Los Angeles, including Disney Hall and the Hollywood Bowl."} image={conducting} imageDescription={"A short and descriptive section describing the above picture, its context and relation to the relevant job title"} featuredWorks={[]} />
        <JobTitleCard bgColor={"#BB602F"} alignment={'left'} title={"Vocalist"} tag={"vocalist"} description={"Edie's vocals have been featured on best selling albums and live on tour with some of the top artists of all time. Her voice has also contributed to the scores & soundtracks of hundreds of movies, TV shows, and video games."} image={singing} imageDescription={"A short and descriptive section describing the above picture, its context and relation to the relevant job title"} featuredWorks={[]} />
        ...
        <JobTitleCard bgColor={"#A1432A"} alignment={'right'} title={"Arranger"} tag={"arranger"} description={"Edie has arranged vocal parts for film music and radio hits alike."} image={arranger} imageDescription={"A short and descriptive section describing the above picture, its context and relation to the relevant job title"} featuredWorks={[]} />
    </div>
  )
}
