            ...
            <div className='w-full h-full flex flex-col items-start justify-start'>
                <div className='w-[700px] flex flex-col items-start justify-start px-16 pt-4 bg-blue2'>
                    ...
                    <div className='w-full h-[120px] grid grid-cols-3 gap-2 text-center text-[18px] font-medium mb-24 text-black'>
                            ...
                            <HashLink to={'/#contract-prep'} scroll={element => scrollWithNavbarOffset(element, 150)} className='w-full h-[60px] border-darkBlue3 border-8 flex items-center justify-center transform hover:scale-105 hover:font-semibold duration-150 origin-top'>Contract Prep</HashLink>
                        </div>
