  ...
  return (
    <div id='up-and-coming' className='flex flex-col w-full items-center bg-green/5'>
        ...
        <div className='w-full border-y-[8px] flex justify-center border-green bg-green/15 mb-8'>
            <div className='py-4 px-4 sm:px-0 font-semibold flex text-start items-center text-4xl text-black/75 wlg'>
        ...
        {/* 1: THE ACOLYTE */}
        <div className='flex flex-col sm:flex-row text-wrap w-full lg:w-[900px] xl:w-[1100px] sm:h-[500px] pb-8'>
            
            <img src={theAcolyte} className='h-full w-full sm:w-[400px] object-cover object-top'/>
            <div className='flex flex-col w-full justify-center items-start p-4 sm:p-0 sm:pl-8 sm:border-y-[1px] sm:border-r-[1px] border-black'>
                <div className='text-4xl font-semibold'>
                    The Acolyte
                </div>
                <div className='pt-1 text-xl italic font-medium sm:ml-4'>
                    Vocalist & Vocal Contractor
                </div>
                <div className='pt-2 text-md italic sm:w-[500px] sm:ml-8'>
                ...
                <div className='sm:ml-8 text-sm pt-4'>
        ...
        <div className='flex flex-col sm:flex-row text-wrap w-full lg:w-[900px] xl:w-[1100px] sm:h-[500px] pb-8'>
            <img src={kingdom} className='h-full w-full sm:w-[400px] object-cover object-top'/>
            <div className='flex flex-col w-full justify-center items-start p-4 sm:p-0 sm:pl-8 sm:border-y-[1px] sm:border-r-[1px] border-black object-left-top'>
                <div className='text-4xl font-semibold'>
        ...
        <div className='flex flex-col sm:flex-row text-wrap w-full lg:w-[900px] xl:w-[1100px] sm:h-[500px] pb-8'>
            <img src={thelmaTheUnicorn} className='h-full w-full sm:w-[400px] object-cover object-top'/>
            <div className='flex flex-col w-full justify-center items-start p-4 sm:p-0 sm:pl-8 sm:border-y-[1px] sm:border-r-[1px] border-black object-left-top'>
                <div className='text-4xl font-semibold'>
                    Thelma the Unicorn
                </div>
