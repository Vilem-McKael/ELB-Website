...
export default function VideoPage() {
  ...
  If you're a fan of big blockbusters like Dune or Encanto, you won't want to miss this behind-the-scenes action.`} videoId={"Ge8peK70N2g"} />
        <VideoCard title={"Edie Lehmann Boddicker Buffalo Music Hall of Fame Class of 2021"} description={`The Official video marking Edie's induction into the Buffalo Music Hall of Fame.`} videoId={"NSisNc8nZT4"} />
        ...
        <VideoCard title={"Living with a Genius"} description={`This video is about musician Edie Lehmann Boddicker`} videoId={"0JKbHNXpq3M"} />
      </div>
      <Footer />
    </div>
  )
